...
def one_pull():
    ...
    if pull == ['Синька']: #Если падает синее, выдаем.
        ...
        print("   ТУТ ЛЕГЕНДАРКА БОООООЙ! \n") #Выдаем сообщение, что в нашей выборке появилась лега.
...
while True: #Цикл для меню со статистикой и выбором количество прокруток.
    ...
    try: #Ловим ошибки
        ...
        if gacha == 1: #Если выбрали один пул
            x = x + 1
            print("  Вы молитесь " + str(x) + " раз/а и вам выпадает:\n\n")
            print("   " + one_pull() + "\n")
            print("")
            

        elif gacha == 10: #Если выбрали два пула
            x = x + 10
            print("  Вы молитесь " + str(x) + " раз/а и вам выпадает:\n\n")
            print("   " + ten_pull())
            print("")
